...
カバーする要件:
  ...
  - ハーモニクス2（基音 + 19半音）: B5(83)=E4+19, C6(84)=F4+19
  - 付点4分音符（Q.）
  - 付点8分音符（E.）
  - 二重付点4分音符（Q..）
  - 二重付点8分音符（E..）
...
ノート列（4/4拍子、120BPM、ticks_per_beat=480）:
  ...
  小節3: ハーモニクス
    ...
    tick=4800: B5(83)  Q.   vel=64  ハーモニクス2 (E4+19) 付点4分
    tick=5520: C6(84)  E    vel=64  ハーモニクス2 (F4+19)
...
def main() -> None:
    notes: list[tuple[int, int, int, int]] = [
        ...
        (4800, 83, Qd,  64),   # B5  = E4+19   ハーモニクス2 付点4分
        (5520, 84, E,   64),   # C6  = F4+19   ハーモニクス2 8分
